...
// (currently set to 127.0.0.1 but must be changed to access remotely).
if ($_SERVER['REMOTE_ADDR'] != "127.0.0.1") {
   ...
   echo '
            ...
            <tr><td>Payout This Round: </td><td>' . $roundltc . ' CCN</td></tr>
            <tr><td>Total Payout: </td><td>' . $dailytotal . ' CCN</td></tr>
            <tr><td>Total Submitted: </td><td>' . $subrows . '</td></tr> 
            <tr><td>Donate: </td><td>' . $btclient->getbalance($don_faucet, 0) .' CCN</td></tr>
...
<th><font face="Arial, Helvetica, sans-serif"><center>CCN Address</center></font></th>
